...
public class MoveTwo extends BaseFragment {
...
//是否开启上拉加载功能
    ...
    private void getNews(final boolean boo){
        ...
        model.getTweet("-1", pageIndex + "", load + "", new MyCallback() {
            @Override
